...
decision-tree-depth-analysis
 - plots/
   ...
   - figura2_gap_generalizacao.png: Diferença entre Treino/Teste por profundidade (DT)
   - figura2b_gap_generalizacao_rf.png: Diferença entre Treino/Teste por profundidade (RF)
   ...
   - figura6_evolucao_cortes_painel.png: Histograma revelando a fragmentação ("decoreba")
   ...
   - figura9_feature_importance_rf.png: Distribuição das variáveis mais importantes no Ensemble
...
O experimento chegou às seguintes conclusões práticas, exploradas em mais detalhes no arquivo report.md:

1. O Ponto de Inflexão (Overfitting): Árvores rasas (profundidade 2 a 6) conseguem criar regras gerais. A partir da profundidade 8 a 12, a Árvore de Decisão continua decorando os dados de treino. A acurácia de treino beira 100%, mas a de teste para de crescer, gerando um imenso Gap de Generalização.
